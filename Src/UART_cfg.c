...
{
		/************************************ USART2 ************************************/
		{UART2, USART_STD_BAUD_9600, DATA_8_BIT, OneStopbit, USART_MODE_TXRX, Paritycontroldisabled, UE_ENABLE},
		/************************************ USART1 ************************************/
		{UART1, USART_STD_BAUD_9600, DATA_8_BIT, OneStopbit, USART_MODE_TXRX, Paritycontroldisabled, UE_DISEBLE},
		/************************************ USART3 ************************************/
		{UART3, USART_STD_BAUD_9600, DATA_8_BIT, OneStopbit, USART_MODE_TXRX, Paritycontroldisabled, UE_DISEBLE}
};
